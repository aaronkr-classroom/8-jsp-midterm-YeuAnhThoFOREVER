...
<html lang="en">
  ...
  <body>
      ...
      <div class="container col-xl-10 col-xxl-8 px-4 py-5">
        <div class="row align-items-center g-lg-5 py-5">
          ...
          <div class="col-lg-6">
            <figure>
              <img
                src="https://www.badminton.or.jp/players_photo/2023/MIYAZAKITOMOKA_20230112.jpg?11"
                alt="Badminton Player Image"
                class="img-fluid"
              />
            </figure>
          </div>
    ...
    <footer class="text-center fixed-bottom bg-dark text-bg-dark pt-3">
      <p class="ut-red">
        <span class="text-white">&copy; 2023</span> [[[ 응엔 꽤 비엔/ 20232429 ]]]
      </p>
    </footer>
